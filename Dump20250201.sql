CREATE DATABASE  IF NOT EXISTS `lmshibernetproject` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `lmshibernetproject`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: localhost    Database: lmshibernetproject
-- ------------------------------------------------------
...
CREATE TABLE `loan` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_2ru19tl9ogtq7fohd1mrkmefh` (`book_id`),
...
-- Dump completed on 2025-02-01 11:52:21
